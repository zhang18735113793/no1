        ...
        <div id="page-infinite-scroll-bottom" class="page">
            ...
            <div class="column-wrapper">
                <div class="column-inner">
                    <!--首页头部-->
                    <div class="show"><a href="{{url('IndexController/userpage')}}" class=""><i></i>晒单</a></div>
                </div>
            </div>
            <!--列表内容-->
                ...
                <div class="wx-show-inner">
                    <div id="divPostList" class="marginB">
                        ...
                        <div class="show-list" postid="421452">
                            <div class="show-head">
                                <a href="/v44/userpage/1010835186" class="show-u blue">厦门</a>
                            ...
                            <a href="/v44/post/detail-421452.do">
                                ...
                                <div class="show-con">
                                    <p name="content">{{$v->sharcontent}}</p>
                                </div>
                            </a>
